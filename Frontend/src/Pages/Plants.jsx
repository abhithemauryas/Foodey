...
export default function Cakes({ children }) {
  ...
  const getData = (page) => {
    ...
    axios
      .get(
        `https://flowers-wdds.onrender.com/plants?_limit=8&_page=${page}`
      )
      .then((res) => {
        console.log(res);
        setMdata(res.data);
            ...
            <Box ml={{ base: 0, md: 60 }} p="4">
              ...
              <div style={{}}>
                ...
                <Image
                  ...
                  w="100%"
                  h="30vh"
                  src="https://www.purehomeandliving.com/cdn/shop/collections/Home_Decor.png?v=1708665103?stp=dst-jpg_s960x960&_nc_cat=103&ccb=1-7&_nc_sid=e3f864&_nc_ohc=T0Qdjc4-BZAAX-R0Tyd&_nc_ht=scontent.fpat2-1.fna&oh=00_AfD3TL87ekpBCai-Nu9QSjjMPHdKkDRR83STraN7b87goQ&oe=63FDE9B5"
                />
              </div>
              <PlantsCarousal />
              <Allpagesome />
